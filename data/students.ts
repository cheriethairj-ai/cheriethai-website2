...
export const students: Student[] = [
  ...
  },
  {
    ...
    bio: 'Based between Montevideo, Uruguay and London, Sofia brings together her background in yoga and the CherieThai Method through movement that is fluid, expansive and beautifully coordinated.',
    bioPoints: [
    ...
    bioPT: 'Baseada entre Montevidéu, Uruguai e Londres, Sofia integra sua experiência em yoga ao Método CherieThai por meio de um movimento fluido, expansivo e extremamente coordenado.',
    bioPTPoints: [
  ...
  },
  {
    ...
    bioPTPoints: [
      ...
      'Seu trabalho une consciência somática e terapia manual de forma restauradora, cuidadosa e profundamente individual.',
    ],
  ...
  },
  {
    ...
    bioPTPoints: [
      ...
      'Como terapeuta e professora, integra ao CherieThai uma trajetória já consolidada de conhecimento, expressando o Método com notável maturidade técnica.',
    ],
