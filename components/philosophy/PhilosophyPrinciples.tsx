...
const principlesData = {
  ...
  EN: [
    ...
    },
    {
      ...
      body: `Nuance is the art of perceiving and responding to the smallest variations in tissue, breath, rhythm, and physical response throughout a session.\n\nThrough refined observation and controlled intention, pressure, timing, direction, and movement are continuously adjusted to create treatments that feel deeply individualized and precisely attuned.\n\nAt CherieThai, nuance transforms technique into craft.`,
      footerLabel: 'CHERIETHAI PHILOSOPHY',
      accent: '#DCC9A0',
      bg: 'light' as const,
    },
    {
      ...
      body: `Precision is the disciplined ability to access the exact structures that require intervention, delivering the appropriate depth with clarity and control.\n\nThe exploration of multiple layers of pressure allows the therapist to work with exceptional specificity, addressing complex structural and muscular patterns with greater accuracy.\n\nWhen the body feels safe within the precision of touch, trust develops naturally, allowing for a deeper therapeutic response and more effective outcomes.`,
      footerLabel: 'CHERIETHAI PHILOSOPHY',
      accent: '#AAB6A2',
      bg: 'dark' as const,
    },
