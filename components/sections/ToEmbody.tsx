...
const translations = {
  ...
  EN: {
    ...
    body: "The aesthetic we're recognized for. Now translated into clothing, objects, and atmosphere. Everything that shapes the CherieThai environment, reinterpreted for everyday life.",
    note: 'Early releases will be announced first to those already part of our community.',
