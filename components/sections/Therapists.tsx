  ...
  PT: [
    {
      ...
      note: 'Lista de espera aplicável · sujeito a disponibilidade.',
      ...
      priceLabel: 'Sessão · a partir de 1h40',
      price: 'R$ 980',
      supportingTone: null as string | null,
      consultationNote: 'Disponibilidade reduzida. Formatos mais curtos disponíveis mediante consulta. Além das sessões individuais, Cherie trabalha com diferentes modalidades terapêuticas para identificar a abordagem mais adequada para você.',
    },
    {
      id: 'karl',
      name: 'Karl Georges',
  ...
  EN: [
    {
      ...
      note: 'Waitlist may apply · subject to availability.',
      imageSub: 'Hands in structural work · Clinical light',
      image: '/portrait-cherie-2.jpg',
      imagePosition: 'center 30%' as const,
      imageZoom: 1.5,
      imageZoomOrigin: 'center 30%',
      priceLabel: 'Session · from 1h40',
      price: 'R$ 980',
      supportingTone: null as string | null,
      consultationNote: 'Limited availability. Shorter formats available upon request. Beyond individual sessions, Cherie works through different therapeutic modalities to identify the approach best suited to you.',
    },
    {
      id: 'karl',
      name: 'Karl Georges',
...
export const therapistsData = {
  PT: [
    {
      ...
      accent: '#AAB6A2',
      image: '/portrait-lucas2.jpg' as string | null,
    ...
    },
    {
      id: 'pedro',
      name: 'Pedro',
      role: 'Praticante · Lutador Profissional de MMA · Trabalho Profundo de Precisão',
      location: 'São Paulo',
      ...
      accent: '#DCC9A0',
      image: '/portrait-pedro2.jpg' as string | null,
      imagePosition: 'center center',
    ...
    },
    {
      ...
      accent: '#DCC9A0',
      image: '/portrait-grace2.jpg' as string | null,
      imagePosition: 'center center',
      priceLabel: 'Sessões com Grace-Kelly' as string | null,
      price: 'R$ 450' as string | null,
  ...
  EN: [
    ...
    },
    {
      id: 'pedro',
      name: 'Pedro',
      role: 'Practitioner · Professional MMA Fighter · Precise Deep Work',
      location: 'São Paulo',
