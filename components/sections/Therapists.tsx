  ...
  EN: [
    {
      ...
      atmosphere: `Lucas works through continuous movement. There are no pauses, resets, or moments where the session stops to reorganize itself. From the very first contact, the work already carries depth.\n\nHis hands are large, and he uses them with an enveloping intelligence that creates the feeling of the entire body being held and read simultaneously. The pressure is gentle, grounded, and deeply controlled. Clients describe a hypnotic quality — not through sedation, but through the consistency of the rhythm. The nervous system surrenders because there is nothing to resist.`,
      presence: 'Warm. Fluid. Immersive. There is a carioca intelligence in his work — unhurried, sophisticated, deeply embodied.',
      strengths: [
    ...
    },
    {
      ...
      presence: 'Intense. Precise. Surprisingly calm for someone who fights professionally. Restraint is part of the gift.',
      strengths: [
        'Combat anatomy knowledge applied to bodywork',
        'Precise deep tissue work',
        'Access to dense athletic musculature',
        'Understanding of tension patterns in martial arts',
        'Sports injury recovery and prevention',
        'High-performance body management',
      ],
      ideal: 'High-performance athletes with dense musculature. Martial artists, fighters, and athletes who need someone who understands their body from within the sport. Those seeking real depth, from someone who knows exactly what extreme pressure does to tissue.',
      ...
      price: 'R$ 350' as string | null,
      supportingTone: 'Precise deep tissue work with combat anatomical vocabulary, for bodies that demand real access.' as string | null,
      consultationNote: 'Availability and additional formats upon request.',
    },
    {
      id: 'grace-kelly',
      ...
      atmosphere: `Grace-Kelly's sessions are known for balance and refinement: between firm and fluid, structural and responsive, between deep tissue release and delicate perception.\n\nHer elbow and forearm work reaches significant depth — without the sensation of force. Her hand and finger work is extraordinarily refined, following the architecture of the muscle with a specificity that clients often describe as being seen, not treated. There is a distinctly feminine quality to her touch — not in lightness, but in texture. In attention. In the particular intelligence of a pressure that knows exactly when to soften and when to hold.`,
      presence: 'Elegant. Composed. Quietly authoritative. The kind of practitioner who requires no announcement.',
      strengths: [
        'Precise elbow and forearm techniques',
        'Detailed hand and finger work',
        'Elegant mobility and stretching',
        'Balanced deep and superficial release',
        'Nervous system regulation',
        'Refined postural bodywork',
      ],
      ideal: "Those who need depth without intensity, structural release without feeling overworked. Clients recovering from stress-related tension patterns. Those who have been told they are 'too sensitive' and dismissed. They are not too sensitive. They need more precision.",
    ...
    },
    {
      ...
      ideal: "Those who carry tension as a full-body pattern. Athletes in maintenance. Clients who have never experienced truly continuous bodywork and want to understand what integration means.",
      ...
      price: null as string | null,
      supportingTone: null as string | null,
      consultationNote: 'Availability and therapeutic options upon direct consultation.',
    },
  ],
}
