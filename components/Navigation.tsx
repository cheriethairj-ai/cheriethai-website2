...
const navItemsPT = [
  {
    ...
    dropdown: [
      ...
      { label: 'Sobre Cherie', href: '/cherie' },
      { label: 'Sobre Karl', href: '/karl' },
    ],
  },
  {
    label: 'Clínicas',
    href: '/saopaulo',
    dropdown: [
      { label: 'São Paulo', href: '/saopaulo' },
      { label: 'Rio de Janeiro', href: '/riodejaneiro' },
      { label: 'Resultados', href: '/results', isLarge: true },
    ],
  },
  { label: 'Terapeutas', href: '/therapists' },
  { label: 'To Embody', href: '/toembody' },
  {
    label: 'Instituto',
    href: '/institute',
    dropdown: [
      ...
      { label: 'Alunos', href: '/alunos', isLarge: true },
    ],
  },
]
...
const navItemsEN = [
  {
    ...
    dropdown: [
      ...
      { label: 'About Cherie', href: '/cherie' },
      { label: 'About Karl', href: '/karl' },
    ],
  },
  {
    label: 'Clinics',
    ...
    dropdown: [
      { label: 'São Paulo', href: '/saopaulo' },
      { label: 'Rio de Janeiro', href: '/riodejaneiro' },
      { label: 'Results', href: '/results', isLarge: true },
    ],
  },
  ...
  { label: 'To Embody', href: '/toembody' },
  {
    ...
    dropdown: [
      ...
      { label: 'Workshops', href: '/workshop' },
      { label: 'Students', href: '/alunos', isLarge: true },
    ],
  },
]
