  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          {...entry(0.75)}
          className="body-text text-sand/65 max-w-sm text-base md:text-lg mb-10"
        >
          Structural precision, rooted in Thai heritage. Established across two
          clinics in Brazil — now beginning a new chapter in London.
        </motion.p>

        <motion.div {...entry(0.9)}>
          <a href="#waitlist" className="btn-ghost text-sand/70 border-sand/30 inline-flex">
